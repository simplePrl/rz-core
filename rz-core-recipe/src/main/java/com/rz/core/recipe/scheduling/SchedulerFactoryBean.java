...
public class SchedulerFactoryBean implements InitializingBean {
    ...
    // Logger.getLogger(SchedulerFactoryBean.class);
    /**
     * 触发器列表
     */
     ...
     */
    public void afterPropertiesSet() throws SchedulerException, ParseException {
     ...
     * @throws ParseException
     */
    public void initSchedulerFactory() throws SchedulerException, ParseException {
